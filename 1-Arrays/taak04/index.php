...
<body>
	<?php
        ...
        echo "Speelgoed " . $games['sport']['naam'] . " uit de categorie " . $games['sport']['uitgever'] . " kost " . $games['sport']['prijs'] . "<br>";
        echo "Speelgoed " . $games['action']['naam'] . " uit de categorie " . $games['action']['uitgever'] . "kost " . $games['action']['prijs'] . "<br>";
        echo "Speelgoed " . $games['fps']['naam'] . " uit de categorie " . $games['fps']['uitgever'] ." kost " . $games['fps']['prijs'] . "<br>";
	?>
</body>
